...
exports.cardsEl = void 0;
exports.createCards = createCards;
exports.updateCurrentText = updateCurrentText;
// Keep track of current card

var cardsEl = exports.cardsEl = [];
var cardsData = [{
...
function updateCurrentText() {
  ...
  currentEl.innerText = "".concat(currentActiveCard + 2, "/").concat(cardsEl.length);
}
...
if (cardsContainer) {
  ...
  nextBtn.addEventListener('click', function () {
    _main.cardsEl[currentActiveCard].className = 'card left';
    currentActiveCard += 1;
    if (currentActiveCard > _main.cardsEl.length - 1) {
      currentActiveCard = _main.cardsEl.length - 1;
    }
    _main.cardsEl[currentActiveCard].className = 'card active';
    // updateCurrentText();
  ...
  prevBtn.addEventListener('click', function () {
    _main.cardsEl[currentActiveCard].className = 'card right';
    currentActiveCard -= 1;
    if (currentActiveCard < 0) {
      currentActiveCard = 0;
    }
    _main.cardsEl[currentActiveCard].className = 'card active';
    (0, _main.updateCurrentText)();
  });
