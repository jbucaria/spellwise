...
let textContainer = document.getElementById('spell-word')
...
function updateContent() {
  let content = textContainer.value.replace('|', '')
...
for (let key of allKey) {
  key.addEventListener('click', function () {
    if (key.classList.contains('delete') || key.classList.contains('enter') || key.classList.contains('space') || key.classList.contains('capslock')) {
      return
    }
...
deleteKey.addEventListener('click', function () {
  let textContainerContent = textContainer.value
